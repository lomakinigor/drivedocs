...
export interface Workspace {
  ...
  /**
   * F-031 (2026-05-13) — IDs не-критичных документов (приказ, договор аренды и т.п.),
   * по которым пользователь сказал «у меня уже есть». attentionItems их скрывают,
   * напоминалки не висят. При попытке открыть acked-документ — спецсообщение.
   */
